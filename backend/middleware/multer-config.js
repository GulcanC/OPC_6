...
const storage = multer.diskStorage({
  ...
  destination: (req, file, callback) => {
    // 5 appeler destination, premier argument est null signifie il y a pas erreur, deuxime argument le dossier images
  ...
  filename: (req, file, callback) => {
    ...
    //  nous qvons le nom de fichier et extension
